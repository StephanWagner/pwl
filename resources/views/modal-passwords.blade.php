<div class="modal-content modal-content--passwords">
	<div class="random-passwords__wrapper">
		<div class="random-passwords__options-wrapper">
			<div class="random-passwords__options-container">
				...
				<div class="random-passwords__options-column random-passwords__options-column--fill">
					<div class="random-passwords__length-option-wrapper">
						<div class="random-passwords__length-option-container">
							<input class="random-password__length-option" type="range" min="6" max="48" step="1" value="26">
						</div>
						<div class="random-passwords__length-option-amount"></div>
					</div>
